    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Runnable r = new Runnable() {
            ...
            public void run() {
                ...
                itemList.add(new WasteItem("Condom"));
                itemList.add(new WasteItem("Plastic lighter"));
                itemList.add(new WasteItem("Sheet face mask"));
                itemList.add(new WasteItem("Disposable heating pad"));
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id){
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(Bedroom.this);
