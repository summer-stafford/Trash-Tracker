    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Runnable r = new Runnable() {
            ...
            public void run() {
                ...
                itemList.add(new WasteItem("Plastic brush"));
                itemList.add(new WasteItem("Food container"));
                itemList.add(new WasteItem("Treats container"));
                itemList.add(new WasteItem("Litter bag"));
                itemList.add(new WasteItem("Plastic poop bag"));
                itemList.add(new WasteItem("Litter container"));
                itemList.add(new WasteItem("Plastic litter scoop"));
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id){
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(Pets.this);
