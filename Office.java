    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Runnable r = new Runnable() {
            ...
            public void run() {
                ...
                itemList.add(new WasteItem("Pencil"));
                itemList.add(new WasteItem("Pen"));
                itemList.add(new WasteItem("Lunch bag"));
                itemList.add(new WasteItem("Brown paper bag"));
                itemList.add(new WasteItem("Paper"));
                itemList.add(new WasteItem("Notebook"));
                itemList.add(new WasteItem("Binder"));
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id){
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(Office.this);
